...
export default function ScoresPage() {
  ...
  const handleAddScore = () => {
    ...
    const scores = adminStorage.getScores();
    ...
    adminStorage.saveScores([...scores, newScore]);
    setScores(adminStorage.getScores());
    setFormData({ studentName: '', vocabulary: 0, grammar: 0, speaking: 0, reading: 0, writing: 0, listening: 0 });
    setShowAddModal(false);
  };

  const getAverage = (score: Score) => {
    return Math.round((score.vocabulary + score.grammar + score.speaking + score.reading + score.writing + score.listening) / 6);
  };
